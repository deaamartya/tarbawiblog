...
class General {
    ...
    public static function getMultiLevelOptions($array, $category_id = 0, $parents = [], $selected = []) {
        static $i = 0;
        if ($category_id == 0) {
            foreach ($array as $element) {
                if (($element['category_id'] != 0) && !in_array($element['category_id'], $parents)) {
                    $parents[] = $element['category_id'];
                }
            }
        }
