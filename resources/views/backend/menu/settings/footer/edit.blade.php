            ...
            <div class="col-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fa fa-random"></i> Form Edit Footer</h3>
                    </div>

                    <form role="form" method="post" action="{{route('footer.update', $data->id)}}">
                        {{ csrf_field()}}
                        {{ method_field('put')}}
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" placeholder="name Footer" name="name" value="{{ $data->name}}">
                                </div>
                            </div>
